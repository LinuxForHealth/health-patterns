 ...
 */
package integrationsquad.processors.acd;
...
public class ACDProcessor extends AbstractProcessor {
    public static String VERSION = "ACDProcessor V0.0.1";
     ...
     *
     * ACD_URL_PROPERTY: the location of the ACD service to be called
     * ACD_USERNAME_PROPERTY: the username will default to apikey
     * ACD_SECRET_PROPERTY: the provided apikey (will be hidden when entered in the processor)
     * ACD_RESOURCES_PROPERTY: the resources that will be extracted from the acd response
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        try {
            ...
            if (acdConnection.getResponseCode() == HttpURLConnection.HTTP_OK) { // success on ACD call
                BufferedReader acdIn = new BufferedReader(new InputStreamReader(
                        acdConnection.getInputStream()));
                String acdInputLine;
                acdResponse = new StringBuffer();
                ...
                String acdResponseString = acdResponse.toString();
