package com.ibm.alvearie

import Constants._
import com.ibm.alvearie.service.DataQualityProcess.{
  prepareSourceData,
  processDqChecks
}
import com.ibm.alvearie.utils.GeneralUtil.getFinalProperties
import com.ibm.alvearie.utils.SparkUtil
...
object Main {
  ...
  def printUsage(): Unit = {
    logger.error("Usage: com.ibm.alvearie.Main <name=value> pairs")
    logger.error(
      "Ex: com.ibm.alvearie.Main dqConfig=\"config/dataQualityConfig.json\""
    )
    System.exit(1)
  }
